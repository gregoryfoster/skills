...
| [`init-socraticode`](skills/init-socraticode/) | init socraticode, set up code search, index this project, socraticode setup | Install, configure, and index SocratiCode semantic code search: host preflight (Docker/Node/npx), plugin enablement, a project-adapted Code Exploration Policy + prefetch hook, a context-artifacts manifest, and a blocking index verified green (embeddings + graph + artifacts) |
