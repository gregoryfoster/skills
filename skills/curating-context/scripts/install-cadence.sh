...
# prompted by what these rows show. Rationale:
# curating-context/references/cadence.md — and this file annotated step by step:
# curating-context/references/cadence/workflow.md
#
